...
-- Copiando dados para a tabela empresa.funcionario: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela empresa.pessoa: ~11 rows (aproximadamente)
DELETE FROM `pessoa`;
...
-- Copiando dados para a tabela empresa.projeto: ~12 rows (aproximadamente)
DELETE FROM `projeto`;
